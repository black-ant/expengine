...
public class DatabaseGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/expengine?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        */
        ...
        strategy.setSuperEntityClass(AbstractEntity.class);
