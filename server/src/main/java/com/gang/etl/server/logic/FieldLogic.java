...
public class FieldLogic {
    ...
    public SyncFieldInfo getFieldInfo(String code) {
        ...
        if (null != syncType) {
            ...
            filedQuery.and(item -> item.eq("type_part", syncType.getTypePart() + "_" + syncType.getDataType()).or().eq("app_type",
    ...
    public SyncFieldInfo createInfo(SyncType syncType) {
        ...
        syncFieldInfo.setTypePart(syncType.getTypePart() + "_" + syncType.getDataType());
